...
function Sidenav() {
  // local state to track open/close
  const [isOpen, setIsOpen] = useState(false);

  return (
    <>
      {/* Mobile hamburger button to open the side-nav */}
      <button
        className="fixed top-4 left-4 z-50 text-3xl text-zinc-400 md:hidden"
      ...
      <div
        className={
          `
          fixed top-0 left-0 z-40 h-full w-64 bg-zinc-900 border-r-2 border-zinc-400 p-8 overflow-auto
      ...
      >
        ...
        {/* Brand */}
        <h1 className="text-xl md:text-2xl text-white font-bold mt-12 md:mt-0 mb-8">
